...
*/
ALTER PROCEDURE [dbo].[usp_LoadProfileStatistics]
AS
BEGIN
...
--	Load the usr_ProfileStatistics table
	...
	select
		...
		sum(prof.ScrubQty)				as [ScrubQuantity], 
	...
	*/			 
	...
	from usr_ProfileStatistics as ProfStats
		cross apply (
							select
	...
	*/
	...
	from usr_ProfileStatistics as ProfStats
		join usr_ProfilePeriodSeq as pps on pps.YearPerSeqNo = 1
	...
	*/
	...
	from usr_ProfileStatistics as ProfStats
		join usr_DateFirstLastUse as dflu on dflu.StockCode = ProfStats.StockCode
	...
	*/
	...
	from usr_ProfileStatistics as ProfStats
		left join usr_DateFirstLastUse as dflu on dflu.StockCode = ProfStats.StockCode
											  and dflu.Warehouse = ProfStats.Warehouse
		cross apply (
						select
							case
	...
	*/
	...
	from usr_Profiles as prof
		join usr_ProfileStatistics as psta on psta.StockCode = prof.StockCode	
