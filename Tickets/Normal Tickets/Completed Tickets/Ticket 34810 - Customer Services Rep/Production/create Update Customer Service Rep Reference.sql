...
/****** Object:  Job [Update Customer Service Rep Reference]    Script Date: 5/5/2023 11:30:35 AM ******/
...
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 5/5/2023 11:30:35 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [PRODUCT_INFO.dbo.usp_Update_Reference_CustomerServiceRep]    Script Date: 5/5/2023 11:30:36 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'PRODUCT_INFO.dbo.usp_Update_Reference_CustomerServiceRep', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [PRODUCT_INFO.dbo.usp_Update_Reference_CustomerServiceRep OLD]    Script Date: 5/5/2023 11:30:36 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'PRODUCT_INFO.dbo.usp_Update_Reference_CustomerServiceRep OLD', 
		@step_id=2, 
		@cmdexec_success_code=0, 
		@on_success_action=1, 
		@on_success_step_id=0, 
		...
		@retry_interval=1, 
		@os_run_priority=0, @subsystem=N'TSQL', 
		@command=N'EXECUTE PRODUCT_INFO.dbo.usp_Update_Reference_CustomerServiceRep;', 
