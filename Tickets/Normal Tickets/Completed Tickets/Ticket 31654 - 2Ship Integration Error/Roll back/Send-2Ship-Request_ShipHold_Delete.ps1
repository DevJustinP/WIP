...
Try {
  ...
  [String]$RequestUrl = 'https://api.modeparcel.com/api/DeleteShipment_V1';
  [String]$ResponseBody = '';
  [String]$ResponseCodeOk = '204';
  ...
  $Command = New-Object -TypeName System.Data.SqlClient.SqlCommand -Property @{
	...
	CommandTimeout = 300;
    CommandText = 'dbo.usp_WebRequest_ShipHold_GetDelete';
  };
  ...
  $Command = New-Object -TypeName System.Data.SqlClient.SqlCommand -Property @{
    ...
    CommandType = [System.Data.CommandType]::StoredProcedure;
	CommandTimeout = 300;
    CommandText = 'dbo.usp_WebRequest_ShipHold_SetDelete';
  };
