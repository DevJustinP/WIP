...
/****** Object:  Job [Sugar CRM Export]    Script Date: 9/2/2022 10:31:57 AM ******/
EXEC msdb.dbo.sp_delete_job @job_name=N'Sugar CRM Export', @delete_unused_schedule=1
GO

/****** Object:  Job [Sugar CRM Export]    Script Date: 8/30/2022 4:57:06 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [SugarCRM]    Script Date: 8/30/2022 4:57:06 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Start Talend Job Main_SugarExport]    Script Date: 8/30/2022 4:57:06 PM ******/
