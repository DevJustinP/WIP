...
/****** Object:  Job [Sugar CRM Export]    Script Date: 9/12/2022 3:46:09 PM ******/
EXEC msdb.dbo.sp_delete_job @name=N'SugarCRM', @delete_unused_schedule=1
GO
...
SELECT @ReturnCode = 0
/****** Object:  JobCategory [SugarCRM]    Script Date: 9/12/2022 3:46:09 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [SugarCRM Export Customers]    Script Date: 9/12/2022 3:46:09 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'SugarCRM Export Customers', 
		...
		@flags=40
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [SugarCRM Export Sales Order Header]    Script Date: 9/12/2022 3:46:09 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'SugarCRM Export Sales Order Header', 
		...
		@flags=40
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [SugarCRM Export Sales Order Line]    Script Date: 9/12/2022 3:46:09 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'SugarCRM Export Sales Order Line', 
		...
		@flags=40
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [SugarCRM Export Quote Header]    Script Date: 9/12/2022 3:46:09 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'SugarCRM Export Quote Header', 
		...
		@flags=40
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [SugarCRM Export Quote Detail]    Script Date: 9/12/2022 3:46:09 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'SugarCRM Export Quote Detail', 
		...
		@flags=40
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Log Export File Creation]    Script Date: 9/12/2022 3:46:09 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Every 90 Minutes', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=4, 
		...
		@active_start_date=20220821, 
		@active_end_date=99991231, 
		@active_start_time=60000, 
		@active_end_time=200000, 
		@schedule_uid=N'e6f8ce8a-81d1-478f-a38e-9c4f2d39a83a'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
