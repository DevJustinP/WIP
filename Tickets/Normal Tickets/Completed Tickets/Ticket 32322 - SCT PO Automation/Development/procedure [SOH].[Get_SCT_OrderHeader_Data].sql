...
begin
	...
	select
		...
		addr.ShippingDescription							as [ShipAddrDesc],
		...
		sm.ShippingInstrs + '('+sm.ShippingInstrsCod+')'	as [ShipVia],
		csm.AddressType										as [AddressType],
		csm.DeliveryType									as [DeliveryType],
	...
	from [Sysprocompany100].[dbo].[SorMaster] as sm
		...
		outer apply [soh].[tvf_Fetch_Shipping_Address](ogsm.SalesOrder, ogsm.Branch, ogsm.ShippingInstrsCod, sm.Warehouse) as addr
