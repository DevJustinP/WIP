...
/****** Object:  Table [SugarCrm].[SalesOrderLine_Ref]    Script Date: 11/29/2022 2:19:46 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [SugarCrm].[SalesOrderLine_Ref](
	...
	[MCreditOrderNo] [varchar](20) NULL,
...
ALTER TABLE [SugarCrm].[SalesOrderLine_Ref] ADD  DEFAULT ('') FOR [SCT]
GO