declare @XML as xml = '<Setting Type="Service" Name="Sales Order Handler Service" ApplicationId="46" ApplicationCode="SOH">
  <WebServices>
...
execute [dbo].[usp_Setting_Update] @xml	

execute [dbo].[usp_Setting_Get] 46