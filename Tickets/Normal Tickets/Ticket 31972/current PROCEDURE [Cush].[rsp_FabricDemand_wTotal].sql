...
Modification:  Added in logic to exclude cancelled POs and limited by MN-Warehouse
...
alter PROCEDURE [Cush].[rsp_FabricDemand_wTotal]
...
drop table if exists #FabricDemand
  ...
  EXECUTE Cush.rsp_FabricDemand_Data_wTotal
     @FabricNumberList
...
AND PorMasterDetail.[MWarehouse] = 'MN'  --Added by D Sowell on 3/24/22
