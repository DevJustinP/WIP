...
-------------------------------------------------------------------------------
:CONNECT SQL2008NEW
EXEC SysproCompanyP.sys.sp_addsubscription 
  @publication                      = $(Pub),
...
EXEC SysproCompanyP.sys.sp_addpullsubscription 
  @publication                      = $(Pub), 
...
-------------------------------------------------------------------------------
:CONNECT SQLREPORTING
EXEC SysproCompanyP.sys.sp_addpullsubscription_agent 
  @publication                      = $(Pub), 
  @publisher                        = N'SQL2008NEW', 
  @publisher_db                     = N'SysproCompanyP', 
...
GO
EXEC SysproCompanyP.sys.sp_startpublication_snapshot 
  @publication                      = $(Pub);
GO
