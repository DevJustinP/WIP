...
-------------------------------------------------------------------------------
:CONNECT SQL2008NEW
EXEC transACTION_SummerClassics.sys.sp_addsubscription 
  @publication                      = $(Pub),
...
EXEC transACTION_SummerClassics.sys.sp_addpullsubscription 
  @publication                      = $(Pub), 
...
-------------------------------------------------------------------------------
:CONNECT SQLREPORTING
EXEC transACTION_SummerClassics.sys.sp_addpullsubscription_agent 
  @publication                      = $(Pub), 
  @publisher                        = N'SQL2008NEW', 
  @publisher_db                     = N'transACTION_SummerClassics', 
...
GO
EXEC transACTION_SummerClassics.sys.sp_startpublication_snapshot 
  @publication                      = $(Pub);
GO
