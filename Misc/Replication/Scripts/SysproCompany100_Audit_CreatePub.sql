...
:SETVAR Pub   "SysproCompany100_Audit_001"
:SETVAR PubS "'SysproCompany100_Audit_001'"
...
--  @dbname = N'SysproCompany100_Audit',
--  @optname = N'publish',
--  @value = N'true';
--GO
...
-------------------------------------------------------------------------------
:CONNECT SQL2008NEW
EXEC SysproCompany100_Audit.sys.sp_addpublication
  @publication                      = $(Pub),
  @description                      = N'SQL08',
...
-------------------------------------------------------------------------------
:CONNECT SQL2008NEW
EXEC SysproCompany100_Audit.sys.sp_addpublication_snapshot 
  @publication                      = $(Pub),
  @frequency_type                   = 1,
...
EXEC DBAdmin.Repl.AddArticle_SysproCompany100_Audit @Pub, @Num OUTPUT;
SELECT @Num AS Num;
