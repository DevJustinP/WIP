...
-------------------------------------------------------------------------------
:CONNECT SQL2008NEW
EXEC WarehouseCompany100.sys.sp_addsubscription 
  @publication                      = $(Pub),
...
EXEC WarehouseCompany100.sys.sp_addpullsubscription 
  @publication                      = $(Pub), 
...
-------------------------------------------------------------------------------
:CONNECT SQLREPORTING
EXEC WarehouseCompany100.sys.sp_addpullsubscription_agent 
  @publication                      = $(Pub), 
  @publisher                        = N'SQL2008NEW', 
  @publisher_db                     = N'WarehouseCompany100', 
...
GO
EXEC WarehouseCompany100.sys.sp_startpublication_snapshot 
  @publication                      = $(Pub);
GO
