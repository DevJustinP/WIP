...
-------------------------------------------------------------------------------
:CONNECT SQL2008NEW
EXEC SysproCompanyK.sys.sp_addpublication
  @publication                      = $(Pub),
  @description                      = N'SQL08',
...
-------------------------------------------------------------------------------
:CONNECT SQL2008NEW
EXEC SysproCompanyK.sys.sp_addpublication_snapshot 
  @publication                      = $(Pub),
  @frequency_type                   = 1,
...
EXEC DBAdmin.Repl.AddArticle_SysproCompanyK @Pub, @Num OUTPUT;
SELECT @Num AS Num;
