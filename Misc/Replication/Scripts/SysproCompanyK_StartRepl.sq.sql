...
-------------------------------------------------------------------------------
:CONNECT SQL2008NEW
EXEC SysproCompanyK.sys.sp_addsubscription 
  @publication                      = $(Pub),
...
EXEC SysproCompanyK.sys.sp_addpullsubscription 
  @publication                      = $(Pub), 
...
-------------------------------------------------------------------------------
:CONNECT SQLREPORTING
EXEC SysproCompanyK.sys.sp_addpullsubscription_agent 
  @publication                      = $(Pub), 
  @publisher                        = N'SQL2008NEW', 
  @publisher_db                     = N'SysproCompanyK', 
...
GO
EXEC SysproCompanyK.sys.sp_startpublication_snapshot 
  @publication                      = $(Pub);
GO
