...
-------------------------------------------------------------------------------
:CONNECT SQL2008NEW
EXEC Warehouse_Control.sys.sp_addsubscription 
  @publication                      = $(Pub),
...
EXEC Warehouse_Control.sys.sp_addpullsubscription 
  @publication                      = $(Pub), 
...
-------------------------------------------------------------------------------
:CONNECT SQLREPORTING
EXEC Warehouse_Control.sys.sp_addpullsubscription_agent 
  @publication                      = $(Pub), 
  @publisher                        = N'SQL2008NEW', 
  @publisher_db                     = N'Warehouse_Control', 
...
GO
EXEC Warehouse_Control.sys.sp_startpublication_snapshot 
  @publication                      = $(Pub);
GO
