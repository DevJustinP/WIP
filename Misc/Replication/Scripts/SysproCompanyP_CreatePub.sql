...
-------------------------------------------------------------------------------
:CONNECT SQL2008NEW
EXEC SysproCompanyP.sys.sp_addpublication
  @publication                      = $(Pub),
  @description                      = N'SQL08',
...
-------------------------------------------------------------------------------
:CONNECT SQL2008NEW
EXEC SysproCompanyP.sys.sp_addpublication_snapshot 
  @publication                      = $(Pub),
  @frequency_type                   = 1,
...
EXEC DBAdmin.Repl.AddArticle_SysproCompanyP @Pub, @Num OUTPUT;
SELECT @Num AS Num;
