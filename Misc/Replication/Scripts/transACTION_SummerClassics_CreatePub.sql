...
--  @dbname = N'transACTION_SummerClassics',
--  @optname = N'publish',
--  @value = N'true';
--GO


USE transACTION_SummerClassics
GO
-------------------------------------------------------------------------------
-- Add a publication.
-------------------------------------------------------------------------------
:CONNECT SQL2008NEW
EXEC transACTION_SummerClassics.sys.sp_addpublication
  @publication                      = $(Pub),
  @description                      = N'SQL08',
...
-------------------------------------------------------------------------------
:CONNECT SQL2008NEW
EXEC transACTION_SummerClassics.sys.sp_addpublication_snapshot 
  @publication                      = $(Pub),
  @frequency_type                   = 1,
...
EXEC DBAdmin.Repl.AddArticle_transACTION_SummerClassics @Pub, @Num OUTPUT;
SELECT @Num AS Num;
