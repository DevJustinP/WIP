...
-------------------------------------------------------------------------------
:CONNECT SQL2008NEW
EXEC DBAdmin.sys.sp_addsubscription 
  @publication                      = $(Pub),
...
EXEC DBAdmin.sys.sp_addpullsubscription 
  @publication                      = $(Pub), 
...
-------------------------------------------------------------------------------
:CONNECT SQLREPORTING
EXEC DBAdmin.sys.sp_addpullsubscription_agent 
  @publication                      = $(Pub), 
  @publisher                        = N'SQL2008NEW', 
  @publisher_db                     = N'DBAdmin', 
...
GO
EXEC DBAdmin.sys.sp_startpublication_snapshot 
  @publication                      = $(Pub);
GO
