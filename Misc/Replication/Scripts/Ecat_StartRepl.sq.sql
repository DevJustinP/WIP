...
-------------------------------------------------------------------------------
:CONNECT SQL2008NEW
EXEC Ecat.sys.sp_addsubscription 
  @publication                      = $(Pub),
...
EXEC Ecat.sys.sp_addpullsubscription 
  @publication                      = $(Pub), 
...
-------------------------------------------------------------------------------
:CONNECT SQLREPORTING
EXEC Ecat.sys.sp_addpullsubscription_agent 
  @publication                      = $(Pub), 
  @publisher                        = N'SQL2008NEW', 
  @publisher_db                     = N'Ecat', 
...
GO
EXEC Ecat.sys.sp_startpublication_snapshot 
  @publication                      = $(Pub);
GO
