...
-------------------------------------------------------------------------------
:CONNECT SQL2008NEW
EXEC Accounting.sys.sp_addsubscription 
  @publication                      = $(Pub),
...
EXEC Accounting.sys.sp_addpullsubscription 
  @publication                      = $(Pub), 
...
-------------------------------------------------------------------------------
:CONNECT SQLREPORTING
EXEC Accounting.sys.sp_addpullsubscription_agent 
  @publication                      = $(Pub), 
  @publisher                        = N'SQL2008NEW', 
  @publisher_db                     = N'Accounting', 
...
GO
EXEC Accounting.sys.sp_startpublication_snapshot 
  @publication                      = $(Pub);
GO
