...
:SETVAR Pub   "SysproCompanyS_002"
:SETVAR PubS "'SysproCompanyS_002'"
-------------------------------------------------------------------------------
-- Add a subscription for the publication at the publisher.
-------------------------------------------------------------------------------
:CONNECT SQL2008NEW
EXEC SysproCompanyS.sys.sp_addsubscription 
  @publication                      = $(Pub),
  @subscriber                       = N'SQLREPORTING',
  @destination_db                   = N'SysproCompanyS',
...
EXEC SysproCompanyS.sys.sp_addpullsubscription 
  @publication                      = $(Pub), 
  @publisher                        = N'SQL2008NEW', 
  @publisher_db                     = N'SysproCompanyS',
...
-------------------------------------------------------------------------------
:CONNECT SQLREPORTING
EXEC SysproCompanyS.sys.sp_addpullsubscription_agent 
  @publication                      = $(Pub), 
  @publisher                        = N'SQL2008NEW', 
  @publisher_db                     = N'SysproCompanyS', 
...
GO
EXEC SysproCompanyS.sys.sp_startpublication_snapshot 
  @publication                      = $(Pub);
GO
