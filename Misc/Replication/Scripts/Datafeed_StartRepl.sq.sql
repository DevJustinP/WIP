...
-------------------------------------------------------------------------------
:CONNECT SQL2008NEW
EXEC Datafeed.sys.sp_addsubscription 
  @publication                      = $(Pub),
...
EXEC Datafeed.sys.sp_addpullsubscription 
  @publication                      = $(Pub), 
...
-------------------------------------------------------------------------------
:CONNECT SQLREPORTING
EXEC Datafeed.sys.sp_addpullsubscription_agent 
  @publication                      = $(Pub), 
  @publisher                        = N'SQL2008NEW', 
  @publisher_db                     = N'Datafeed', 
...
GO
EXEC Datafeed.sys.sp_startpublication_snapshot 
  @publication                      = $(Pub);
GO
